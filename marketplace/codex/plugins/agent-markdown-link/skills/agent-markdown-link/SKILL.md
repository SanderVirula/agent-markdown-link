...
description: Use when initializing or configuring Agent Markdown Link, or when a mapped project needs curated local Markdown context, on-demand recall, or a durable memory candidate for human review.
---
